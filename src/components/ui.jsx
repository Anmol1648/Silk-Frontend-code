...
export function Tooltip({ content, children, width = 260, position = 'top' }) {
    ...
    >
      ...
      {show && content && (
        <div style={{
          ...
          marginTop: isBottom ? '8px' : '0',
          marginBottom: isBottom ? '0' : '8px',
          ...
          <div style={{
            ...
            left: '50%',
            transform: `translateX(-50%) ${isBottom ? 'rotate(180deg)' : ''}`,
            borderWidth: '5px',
            borderStyle: 'solid',
            borderColor: isBottom ? 'transparent transparent var(--ink, #1f2937) transparent' : 'var(--ink, #1f2937) transparent transparent transparent'
          }} />
        </div>
      )}
    </div>
